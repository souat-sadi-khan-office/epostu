@extends('admin.layouts.app', ['title' => 'Support FAQ', 'modal' => 'md'])

@section('content')
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Support FAQ</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Support FAQ</li>
                    </ol>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    <a href="javascript:;" data-url="{{ route('admin.support-faq.create') }}" id="content_management" class="btn btn-success">
            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">Support FAQ</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable-buttons').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.support-faq.index') }}",
                columns: [
