@extends('admin.layouts.app', ['title' => 'Knowledge Base', 'modal' => 'md'])
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    ...
                    <a href="{{ route('admin.knowledge-base.create') }}" class="btn btn-success">
                        Create New
                    </a>
                </div>                        
            </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable-buttons').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.knowledge-base.index') }}",
                columns: [
